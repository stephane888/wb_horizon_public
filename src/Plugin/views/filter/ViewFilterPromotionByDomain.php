...
use Drupal\view_filter_promotion\Plugin\views\filter\ViewFilterPromotion;
 ...
 *
 * @ViewsFilter("view_filter_promotion_by_domain")
 */
class ViewFilterPromotionByDomain extends ViewFilterPromotion {
